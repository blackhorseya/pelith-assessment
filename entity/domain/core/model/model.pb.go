...
var file_entity_domain_core_model_model_proto_rawDesc = []byte{
	...
	0x74, 0x2a, 0x59, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a,
	...
	0x53, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x03, 0x42, 0xf8, 0x01,
...
var file_entity_domain_core_model_model_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_entity_domain_core_model_model_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_entity_domain_core_model_model_proto_goTypes = []any{
	...
	(*Task)(nil),                  // 4: entity.domain.core.model.Task
	(*TaskCriteria)(nil),          // 5: entity.domain.core.model.TaskCriteria
	(*TaskResult)(nil),            // 6: entity.domain.core.model.TaskResult
	(*Campaign)(nil),              // 7: entity.domain.core.model.Campaign
	(*User)(nil),                  // 8: entity.domain.core.model.User
	(*PointAllocation)(nil),       // 9: entity.domain.core.model.PointAllocation
	(*Reward)(nil),                // 10: entity.domain.core.model.Reward
	nil,                           // 11: entity.domain.core.model.User.TaskProgressEntry
...
var file_entity_domain_core_model_model_proto_depIdxs = []int32{
	...
	5,  // 1: entity.domain.core.model.Task.criteria:type_name -> entity.domain.core.model.TaskCriteria
	1,  // 2: entity.domain.core.model.Task.status:type_name -> entity.domain.core.model.TaskStatus
	12, // 3: entity.domain.core.model.TaskResult.completed_at:type_name -> google.protobuf.Timestamp
	12, // 4: entity.domain.core.model.Campaign.start_time:type_name -> google.protobuf.Timestamp
	12, // 5: entity.domain.core.model.Campaign.end_time:type_name -> google.protobuf.Timestamp
	...
	11, // 8: entity.domain.core.model.User.task_progress:type_name -> entity.domain.core.model.User.TaskProgressEntry
	12, // 9: entity.domain.core.model.Reward.redeemed_at:type_name -> google.protobuf.Timestamp

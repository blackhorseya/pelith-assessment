...
type SwapDetail struct {
	...
	FromTokenAmount int64 `protobuf:"varint,3,opt,name=from_token_amount,json=fromTokenAmount,proto3" json:"from_token_amount,omitempty"`
	// Amount of the to_token received
	ToTokenAmount int64 `protobuf:"varint,4,opt,name=to_token_amount,json=toTokenAmount,proto3" json:"to_token_amount,omitempty"`
...
func (x *SwapDetail) GetFromTokenAmount() int64 {
	if x != nil {
...
func (x *SwapDetail) GetToTokenAmount() int64 {
	if x != nil {
...
var file_entity_domain_core_model_model_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x0f, 0x66, 0x72, 0x6f, 0x6d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x26, 0x0a, 0x0f, 0x74, 0x6f, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x74,

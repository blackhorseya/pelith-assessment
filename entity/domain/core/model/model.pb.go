...
type Transaction struct {
	...
	// Unique identifier for the transaction (blockchain hash)
	// @gotags: db:"tx_hash"
	TxHash []byte `protobuf:"bytes,1,opt,name=tx_hash,json=txHash,proto3" json:"tx_hash,omitempty" db:"tx_hash"`
	// Blockchain sender address
	// @gotags: db:"from_address"
	FromAddress []byte `protobuf:"bytes,2,opt,name=from_address,json=fromAddress,proto3" json:"from_address,omitempty" db:"from_address"`
	// Blockchain receiver address
	// @gotags: db:"to_address"
	ToAddress []byte `protobuf:"bytes,3,opt,name=to_address,json=toAddress,proto3" json:"to_address,omitempty" db:"to_address"`
	// Transaction amount
	// @gotags: db:"amount"
	Amount float64 `protobuf:"fixed64,4,opt,name=amount,proto3" json:"amount,omitempty" db:"amount"`
	// Timestamp of the transaction on the blockchain
	// @gotags: db:"timestamp"
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=timestamp,proto3" json:"timestamp,omitempty" db:"timestamp"`
	// Associated task ID (optional for task tracking)
	// @gotags: db:"task_id"
	TaskId *string `protobuf:"bytes,6,opt,name=task_id,json=taskId,proto3,oneof" json:"task_id,omitempty" db:"task_id"`
	// Associated campaign ID (optional for campaign tracking)
...
var file_entity_domain_core_model_model_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xdf, 0x02, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x72,
	0x6f, 0x6d, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c,
	...
	0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x00, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x24, 0x0a, 0x0b,
	0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x01, 0x52, 0x0a, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x49, 0x64, 0x88,
	0x01, 0x01, 0x12, 0x43, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x64, 0x6f, 0x6d, 0x61,
	...
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x74, 0x61, 0x73, 0x6b,
	0x5f, 0x69, 0x64, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e,
	0x5f, 0x69, 0x64, 0x2a, 0x59, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x53, 0x4b, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4f, 0x4e, 0x42, 0x4f, 0x41, 0x52, 0x44, 0x49,
	0x4e, 0x47, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x54, 0x41, 0x53, 0x4b, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x53, 0x48, 0x41, 0x52, 0x45, 0x5f, 0x50, 0x4f, 0x4f, 0x4c, 0x10, 0x02, 0x2a, 0x5b,
	...
	,
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1b, 0x0a, 0x17, 0x43, 0x41, 0x4d, 0x50, 0x41,
	0x49, 0x47, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x50, 0x45, 0x4e, 0x44, 0x49,
	0x4e, 0x47, 0x10, 0x01, 0x12, 0x1a, 0x0a, 0x16, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e,
	...
	0x98, 0x01, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f,
	0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x02, 0x12, 0x1d, 0x0a, 0x19, 0x54,
	0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55,
	0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0xf8, 0x01, 0x0a, 0x1c, 0x63,
	0x6f, 0x6d, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e,
	0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x42, 0x0a, 0x4d, 0x6f, 0x64,
	0x65, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x48, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_entity_domain_core_model_model_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_entity_domain_core_model_model_proto_goTypes = []any{
	...
	(*Task)(nil),                  // 5: entity.domain.core.model.Task
	(*TaskCriteria)(nil),          // 6: entity.domain.core.model.TaskCriteria
	(*TaskResult)(nil),            // 7: entity.domain.core.model.TaskResult
	(*Campaign)(nil),              // 8: entity.domain.core.model.Campaign
	(*User)(nil),                  // 9: entity.domain.core.model.User
	(*PointAllocation)(nil),       // 10: entity.domain.core.model.PointAllocation
	(*Reward)(nil),                // 11: entity.domain.core.model.Reward
	(*Transaction)(nil),           // 12: entity.domain.core.model.Transaction
	nil,                           // 13: entity.domain.core.model.User.TaskProgressEntry
...
var file_entity_domain_core_model_model_proto_depIdxs = []int32{
	...
	6,  // 1: entity.domain.core.model.Task.criteria:type_name -> entity.domain.core.model.TaskCriteria
	1,  // 2: entity.domain.core.model.Task.status:type_name -> entity.domain.core.model.TaskStatus
	14, // 3: entity.domain.core.model.TaskResult.completed_at:type_name -> google.protobuf.Timestamp
	14, // 4: entity.domain.core.model.Campaign.start_time:type_name -> google.protobuf.Timestamp
	14, // 5: entity.domain.core.model.Campaign.end_time:type_name -> google.protobuf.Timestamp
	...
	13, // 8: entity.domain.core.model.User.task_progress:type_name -> entity.domain.core.model.User.TaskProgressEntry
	14, // 9: entity.domain.core.model.Reward.redeemed_at:type_name -> google.protobuf.Timestamp
	14, // 10: entity.domain.core.model.Transaction.timestamp:type_name -> google.protobuf.Timestamp
...
func file_entity_domain_core_model_model_proto_init() {
	...
	file_entity_domain_core_model_model_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
